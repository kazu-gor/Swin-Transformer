...
def build_model(config, is_pretrain=False):
    ...
    if model_type == 'swin':
        ...
        model = PatchSelectionTransformer(# transformer decoder
                                          d_model=config.MODEL_DECODER.D_MODEL,
                                          nhead=config.MODEL_DECODER.NHEAD,
                                          num_decoder_layers=config.MODEL_DECODER.NUM_DECODER_LAYERS,
                                          dim_feedforward=config.MODEL_DECODER.DIM_FEEDFORWARD,
                                          dropout=config.MODEL_DECODER.DROPOUT,
                                          activation=config.MODEL_DECODER.ACTIVATION,
